          ...
          <div class="space-y-2">
            <div v-for="(save, index) in item.datas">
              <div v-if="itemIndex == 0" class="border-b">
                <h3 class="border-r uppercase text-xs border-secondary/50">
                ...
                <div class="flex items-center justify-start mt-2 gap-5 text-end">
              ...
              <div v-if="itemIndex == 1" class="border-b">
                ...
                <h3 class="border-r uppercase text-xs border-secondary/50">
                  <span class="font-bold">Tasks performed</span> {{ save.tasks }}
                </h3>
