...
<template>
  <section class="relative min-h-screen " id="content">
    ...
    >
      <div class="col-span-2 bg-stone-100 h-full"></div>
      <div class="col-span-3"></div>
    </div>
    <div class="relative  z-10">
      <div class="flex justify-center py-5">
        <div class="w-3/6 p-3 text-center bg-white border-2 border-pink-600">
          <h1
      ...
      <div class="grid grid-cols-5 px-8">
        <div class="flex flex-col col-span-2 gap-4 p-3 px-6">
          <div>
            <h2
              class="mb-3 text-lg font-bold uppercase border-b-2 border-b-stone-400"
            >
              CONTACT
            </h2>
            <ul class="pr-6">
          ...
          <div v-if="educations && educations.length > 0">
            <h2
              class="my-3 text-lg font-bold uppercase border-b-2 border-b-stone-400"
            >
              Education
            </h2>
        ...
        <div class="flex flex-col col-span-3 gap-6 p-3 px-6">
          <div v-if="resume">
            <h2
              class="mb-4 text-lg font-bold uppercase border-b-2 border-b-stone-400"
            >
              Profile
            </h2>
            <p contenteditable="">
