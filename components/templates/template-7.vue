    ...
    >
      <div class="h-full">
        <div class="p-4 py-10 pb-20">
          <h1 class="text-3xl font-bold">{{ nom }} {{ prenom }}</h1>
            ...
            <div>
              ...
              <ul class="relative flex flex-col gap-5 mt-4">
                <li v-for="workExperience in workExperiences">
                  ...
                  >
                  <span class="absolute left-0 w-20">
                    {{ workExperience.startDate }} - {{ workExperience.endDate }}
                  </span>
                    <div class="w-full">
                      <span class="font-bold">{{ workExperience.jobTitle }}</span> <br />
                    </div>
                  </div>
                  <div
                ...
                <li v-for="education in educations">
                  ...
                  >
                    <div class="w-full">
                      ...
                      <h2 class="my-1">{{ education.grade }}</h2>
                    </div>
                  </div>
                </li>
              </ul>
